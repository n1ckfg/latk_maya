...
cat "latkpy/latk.py" "latk_main.py" "latk_tools.py" "latk_rw.py" "latk_mtl.py" "latk_mesh.py" "latk_draw.py" "latk_shortcuts.py" "latk_ui.py" "latk_tilt.py" "latk_svg.py" > $BUILD_TARGET
